...
<body>
                    ...
                    <div class="header-right d-none d-lg-flex">
                        <div class="header-dropdown dropdown-expanded">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li><a href="dashboard.html">Liên hệ </a></li>
                                    <?php 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 p-0">
                                                <div class="menu-banner">
                                                    ...
                                                    <figure>
                                                        <img src="admin/view/upload/menu-banner.jpg" alt="Menu banner"
                                                            width="120" height="70">
                                                    </figure>
    ...
    <input type="hidden" name="act" value="timkiemsanpham"> <!-- Thêm trường ẩn để xác định hành động -->
                            ...
                            <div class="dropdown-menu mobile-cart">
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <?php foreach($item as $key=>$value): 
										...
										$tien= $value['gia_goc'] * $value['quantity'];
										$totalPrice +=$tien; 
										?>
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo27-product.html" class="product-image">
                                                    <img src="views/admin/view/upload/<?=$value['anh_sp']?>" alt="product"
                                                        width="80" height="80">
                                                </a>
