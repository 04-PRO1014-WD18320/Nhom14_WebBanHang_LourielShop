                    ...
                    <div class="row m-0 align-items-center">
                        ...
                        <div class="col-md-8 col-lg-9 p-0">
                            <div class="instagram-carousel owl-carousel owl-theme" data-owl-options="{
                                ...
                                <img src="admin/view/upload/a2.jpeg" alt="instagram"
                                    width="240" height="240">
                                <img src="admin/view/upload/a14.jpeg" alt="instagram"
                                    width="240" height="240">
                                <img src="admin/view/upload/a20.jpeg" alt="instagram"
                                    width="240" height="240">
                                <img src="admin/view/upload/a38.jpeg" alt="instagram"
                                    width="240" height="240">
                                <img src="admin/view/upload/a42.jpeg" alt="instagram"
                                    width="240" height="240">
                                <img src="admin/view/upload/a37.jpeg" alt="instagram"
                                    width="240" height="240">
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $("#addToCartBtn").on("click", function (e) {
            e.preventDefault(); // Ngăn chặn hành động mặc định của nút submit trong form
                ...
                success: function (response) {
                    ...
                    if (response === 'require_login') {
                        ...
                        // Hoặc chuyển hướng đến trang đăng nhập
                         window.location.href = 'views/dangnhap/index.php';
                    } else {
                    // Hiển thị thông báo thành công hoặc lỗi
                    $("#addToCartMessage").html(response);

                    // Thay đổi nút thành nút "Đã thêm"
                    $("#addToCartBtn").addClass("added-to-cart").text("Đã thêm");
                    }
                },
...
<script>
  function addToCart() {
    ...
    function closePopup() {
        var popup = document.getElementById('newsletter-popup-form');
