                ...
                <div class="home-slide home-slide-1 banner d-flex flex-wrap">
                    <div class="col-lg-4 d-flex justify-content-center">
                        <div class="d-flex flex-column justify-content-center appear-animate"
                            ...
                            <div>
                                <a href="demo27-shop.html" class="btn btn-dark btn-lg">Xem thêm</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="product-default">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="price-box">
                                        ...
                                        <span class="product-price"> <?=$tam?>  <?=$value['gia_khuyen_mai']?>VND</span>
                                    ...
                                    <div class="product-action">
                                        ...
                                        <a href="#" class="btn-icon-wish" title="wishlist"><i
                                                ...
                                                <a href="index.php?act=themgiohang&id_sp=<?=$value['id_sp'];?>" class="btn-icon btn-add-cart product-type-simple"><i
