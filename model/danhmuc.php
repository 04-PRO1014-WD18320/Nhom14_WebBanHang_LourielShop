...
*/
function insert_danhmuc($ten_dm , $mota_dm){
    $sql= "INSERT INTO danhmuc_sanpham (ten_dm, mota_dm) VALUES ('$ten_dm' , '$mota_dm')";
    pdo_execute($sql);
}
function loadall_danhmuc(){
...
// cập nhập danh mục 
function update_danhmuc($id_dm, $ten_dm, $mota_dm){
